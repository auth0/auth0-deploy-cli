...
| triggerId    | string             | The id of the trigger the hook will be executed as during the some workflow.                               | 'credentials-exchange'          | 'pre-user-registration' | 'post-user-registration' |
