...
## [7.3.6] - 2022-01-27
### Fixed
- Workaround due to pagination issues in organizations API [#404]
...
[#404]: https://github.com/auth0/auth0-deploy-cli/issues/404

[Unreleased]: https://github.com/auth0/auth0-deploy-cli/compare/v7.3.6...HEAD
[7.3.5]: https://github.com/auth0/auth0-deploy-cli/compare/v7.3.4...v7.3.6
