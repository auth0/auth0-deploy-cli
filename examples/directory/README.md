...
By default the tool will also merge in your current enviroments variables and override AUTH0_KEYWORD_REPLACE_MAPPINGS which have the same key. You can disable this via the command line with the `--no-env` option.
